          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <Link href="/app">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white px-8 py-4 text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
                >
                  Start Funding
      ...
      <footer className="border-t py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-sm text-muted-foreground">
            <span>© {new Date().getFullYear()} CrowdFund</span>
            <div className="flex items-center gap-2">
